...
df = df.join(top_performers_df, "product_id", "left_outer").withColumn("top_performer", when(col("above_4_rating_count").isNotNull(), 1).otherwise(0)).drop("above_4_rating_count", "3to4_rating_count", "average_rating")
